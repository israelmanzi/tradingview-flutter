...
class ApiService {
  ...
  Future<void> registerDevice(String deviceName, String secretHash) async {
    await http.post(
  ...
  Future<dynamic> generateDeviceInfo() async {
    final response = await http.get(
        Uri.parse('$gptApiUri/auth/generate-device-info'),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8'
        });
    if (response.statusCode != 200) {
